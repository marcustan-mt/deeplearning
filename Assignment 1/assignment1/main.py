...
def main():
    # Delete here
    train_loss_history, train_acc_history, valid_loss_history, valid_acc_history, extra_label = run()

    plot_curves(train_loss_history, train_acc_history, valid_loss_history, valid_acc_history, extra_label)
    #
...
def run():
    ...
    for epoch in range(args.epochs):
        ...
        _, test_acc = evaluate(batched_test_data, batched_test_label, model)  # test the best model
        ###
    ...
    # Delete here
    print('ARGS HERE', config)
    print('Train Accuracy:', train_acc_history)
    print('Validation Accuracy:', valid_acc)
    extra_label = 'Nodes = 16'
    ###

    return train_loss_history, train_acc_history, valid_loss_history, valid_acc_history, extra_label
