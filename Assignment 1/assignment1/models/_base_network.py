...
class _baseNetwork:
    ...
    def softmax(self, scores):
        ...
        #############################################################################
        total_score = np.sum(np.exp(scores),axis=1, keepdims=True)
        prob = np.exp(scores)/total_score
        #############################################################################
        #                              END OF YOUR CODE                             #
        #############################################################################
    ...
    def cross_entropy_loss(self, x_pred, y):
        ...
        #############################################################################
        range_of_val = np.arange(len(y))
        probabilities = x_pred[range_of_val, y]
    ...
    def compute_accuracy(self, x_pred, y):
        ...
        argmax_indices = np.argmax(x_pred, axis=1)
        compare = argmax_indices == y
        acc = np.sum(compare)*1.00000/len(y)
